...
public class MultipleThreadSearch2 {
	...
	public MultipleThreadSearch2(String filePath, int parallelism) throws IOException {
	...
	public static void main(String args[]) throws Exception {
		System.out.println(new MultipleThreadSearch2("D:/TestContent.txt", 4).execute());
	}
}